 ...
 */
package org.web3moac.codegen.unit.gen;
...
import org.web3moac.codegen.unit.gen.java.MethodParser;
import org.web3moac.codegen.unit.gen.kotlin.FunParser;
...
public class MethodFilter {
    ...
    private static boolean parametersAreMatching(final Method method) {
        if (method.getName().equals("deploy") || method.getName().equals("load")) {
            return Arrays.asList(method.getParameterTypes()).contains(Web3moac.class)
