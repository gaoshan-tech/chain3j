...
import org.web3moac.abi.datatypes.StaticArray;
...
import org.web3moac.protocol.core.RemoteFunctionCall;
...
import org.web3moac.protocol.core.methods.response.BaseEventResponse;
...
import org.web3moac.utils.Collection;
import org.web3moac.utils.Strings;
import org.web3moac.utils.Version;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private static MethodSpec buildConstructor(
        ...
        MethodSpec.Builder toReturn =
                MethodSpec.constructorBuilder()
                        ...
                        .addParameter(Web3moac.class, WEB3J)
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType =
                    ParameterizedTypeName.get(
                            ClassName.get(
                                    "org.web3moac.tuples.generated", "Tuple" + returnTypes.size()),
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<org.web3moac.codegen.SolidityFunctionWrapper.NamedTypeName> indexedParameters,
            List<org.web3moac.codegen.SolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {
        ...
        for (org.web3moac.codegen.SolidityFunctionWrapper.NamedTypeName namedType :
                indexedParameters) {
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String type) {
        try {
            return Class.forName("org.web3moac.abi.datatypes.generated.StaticArray" + type);
