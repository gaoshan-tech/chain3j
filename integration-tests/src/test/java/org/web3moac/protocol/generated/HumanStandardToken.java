package org.web3moac.generated;
...
import org.web3moac.tx.gas.ContractGasProvider;
...
public class HumanStandardToken extends Contract {
    ...
    @Deprecated
    protected HumanStandardToken(String contractAddress, Web3moac web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected HumanStandardToken(String contractAddress, Web3moac web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected HumanStandardToken(String contractAddress, Web3moac web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected HumanStandardToken(String contractAddress, Web3moac web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> approve(String _spender, BigInteger _value) {
        final Function function = new Function(
                FUNC_APPROVE, 
                Arrays.<Type>asList(new org.web3moac.abi.datatypes.Address(_spender),
                new org.web3moac.abi.datatypes.generated.Uint256(_value)),
    ...
    public RemoteCall<TransactionReceipt> transferFrom(String _from, String _to, BigInteger _value) {
        final Function function = new Function(
                FUNC_TRANSFERFROM, 
                Arrays.<Type>asList(new org.web3moac.abi.datatypes.Address(_from),
                new org.web3moac.abi.datatypes.Address(_to),
                new org.web3moac.abi.datatypes.generated.Uint256(_value)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<BigInteger> balanceOf(String _owner) {
        final Function function = new Function(FUNC_BALANCEOF, 
                Arrays.<Type>asList(new org.web3moac.abi.datatypes.Address(_owner)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteCall<TransactionReceipt> transfer(String _to, BigInteger _value) {
        final Function function = new Function(
                FUNC_TRANSFER, 
                Arrays.<Type>asList(new org.web3moac.abi.datatypes.Address(_to),
                new org.web3moac.abi.datatypes.generated.Uint256(_value)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<BigInteger> allowance(String _owner, String _spender) {
        final Function function = new Function(FUNC_ALLOWANCE, 
                Arrays.<Type>asList(new org.web3moac.abi.datatypes.Address(_owner),
                new org.web3moac.abi.datatypes.Address(_spender)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }

    public static RemoteCall<HumanStandardToken> deploy(Web3moac web3j, Credentials credentials, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3moac.abi.datatypes.generated.Uint256(_initialAmount),
                new org.web3moac.abi.datatypes.Utf8String(_tokenName),
                new org.web3moac.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.web3moac.abi.datatypes.Utf8String(_tokenSymbol)));
        return deployRemoteCall(HumanStandardToken.class, web3j, credentials, contractGasProvider, BINARY, encodedConstructor);
    }

    public static RemoteCall<HumanStandardToken> deploy(Web3moac web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3moac.abi.datatypes.generated.Uint256(_initialAmount),
                new org.web3moac.abi.datatypes.Utf8String(_tokenName),
                new org.web3moac.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.web3moac.abi.datatypes.Utf8String(_tokenSymbol)));
    ...
    @Deprecated
    public static RemoteCall<HumanStandardToken> deploy(Web3moac web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3moac.abi.datatypes.generated.Uint256(_initialAmount),
                new org.web3moac.abi.datatypes.Utf8String(_tokenName),
                new org.web3moac.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.web3moac.abi.datatypes.Utf8String(_tokenSymbol)));
    ...
    @Deprecated
    public static RemoteCall<HumanStandardToken> deploy(Web3moac web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3moac.abi.datatypes.generated.Uint256(_initialAmount),
                new org.web3moac.abi.datatypes.Utf8String(_tokenName),
                new org.web3moac.abi.datatypes.generated.Uint8(_decimalUnits),
                new org.web3moac.abi.datatypes.Utf8String(_tokenSymbol)));
    ...
    @Deprecated
    public static HumanStandardToken load(String contractAddress, Web3moac web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new HumanStandardToken(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static HumanStandardToken load(String contractAddress, Web3moac web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new HumanStandardToken(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static HumanStandardToken load(String contractAddress, Web3moac web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new HumanStandardToken(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static HumanStandardToken load(String contractAddress, Web3moac web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
