...
import org.web3moac.abi.datatypes.DynamicArray;
import org.web3moac.abi.datatypes.Function;
import org.web3moac.abi.datatypes.Type;
import org.web3moac.abi.datatypes.generated.StaticArray10;
...
public class Arrays extends Contract {
    ...
    @Deprecated
    protected Arrays(String contractAddress, Web3moac web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected Arrays(String contractAddress, Web3moac web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected Arrays(String contractAddress, Web3moac web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected Arrays(String contractAddress, Web3moac web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<List> multiDynamic(List<List<BigInteger>> input) {
        final Function function = new Function(FUNC_MULTIDYNAMIC, 
                java.util.Arrays.<Type>asList(new org.web3moac.abi.datatypes.DynamicArray<org.web3moac.abi.datatypes.generated.StaticArray2>(
                        org.web3moac.abi.datatypes.generated.StaticArray2.class,
                        org.web3moac.abi.Utils.typeMap(input, org.web3moac.abi.datatypes.generated.StaticArray2.class,
                org.web3moac.abi.datatypes.generated.Uint256.class))),
    ...
    public RemoteCall<List> multiFixed(List<List<BigInteger>> input) {
        final Function function = new Function(FUNC_MULTIFIXED,
                java.util.Arrays.<Type>asList(new org.web3moac.abi.datatypes.generated.StaticArray6<org.web3moac.abi.datatypes.generated.StaticArray2>(
                        org.web3moac.abi.datatypes.generated.StaticArray2.class,
                        org.web3moac.abi.Utils.typeMap(input, org.web3moac.abi.datatypes.generated.StaticArray2.class,
                org.web3moac.abi.datatypes.generated.Uint256.class))),
                java.util.Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Uint256>>() {}));
    ...
    public RemoteCall<List> fixedReverse(List<BigInteger> input) {
        final Function function = new Function(FUNC_FIXEDREVERSE, 
                java.util.Arrays.<Type>asList(new org.web3moac.abi.datatypes.generated.StaticArray10<org.web3moac.abi.datatypes.generated.Uint256>(
                        org.web3moac.abi.datatypes.generated.Uint256.class,
                        org.web3moac.abi.Utils.typeMap(input, org.web3moac.abi.datatypes.generated.Uint256.class))),
    ...
    public RemoteCall<List> dynamicReverse(List<BigInteger> input) {
        final Function function = new Function(FUNC_DYNAMICREVERSE, 
                java.util.Arrays.<Type>asList(new org.web3moac.abi.datatypes.DynamicArray<org.web3moac.abi.datatypes.generated.Uint256>(
                        org.web3moac.abi.datatypes.generated.Uint256.class,
                        org.web3moac.abi.Utils.typeMap(input, org.web3moac.abi.datatypes.generated.Uint256.class))),
                java.util.Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Uint256>>() {}));
        return new RemoteCall<List>(
    ...
    public static RemoteCall<Arrays> deploy(Web3moac web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(Arrays.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<Arrays> deploy(Web3moac web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(Arrays.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<Arrays> deploy(Web3moac web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(Arrays.class, web3j, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<Arrays> deploy(Web3moac web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(Arrays.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    @Deprecated
    public static Arrays load(String contractAddress, Web3moac web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new Arrays(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Arrays load(String contractAddress, Web3moac web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Arrays(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Arrays load(String contractAddress, Web3moac web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new Arrays(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Arrays load(String contractAddress, Web3moac web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
