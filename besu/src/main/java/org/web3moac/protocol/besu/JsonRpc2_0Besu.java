 ...
 */
package org.web3moac.protocol.besu;
...
import org.web3moac.protocol.admin.methods.response.BooleanResponse;
import org.web3moac.protocol.besu.privacy.OnChainPrivacyTransactionBuilder;
import org.web3moac.protocol.besu.request.CreatePrivacyGroupRequest;
import org.web3moac.protocol.besu.response.BesuEthAccountsMapResponse;
import org.web3moac.protocol.besu.response.BesuFullDebugTraceResponse;
import org.web3moac.protocol.besu.response.privacy.PrivCreatePrivacyGroup;
import org.web3moac.protocol.besu.response.privacy.PrivFindPrivacyGroup;
import org.web3moac.protocol.besu.response.privacy.PrivGetPrivacyPrecompileAddress;
import org.web3moac.protocol.besu.response.privacy.PrivGetPrivateTransaction;
import org.web3moac.protocol.besu.response.privacy.PrivGetTransactionReceipt;
import org.web3moac.protocol.besu.response.privacy.PrivateTransactionReceipt;
import org.web3moac.protocol.core.DefaultBlockParameter;
import org.web3moac.protocol.core.Request;
...
import org.web3moac.protocol.core.methods.response.MinerStartResponse;
import org.web3moac.protocol.eea.JsonRpc2_0Eea;
import org.web3moac.protocol.exceptions.TransactionException;
import org.web3moac.tx.response.PollingPrivateTransactionReceiptProcessor;
import org.web3moac.utils.Base64String;
...
public class JsonRpc2_0Besu extends JsonRpc2_0Eea implements Besu {
    ...
    public Request<?, EthLog> privGetLogs(
            final String privacyGroupId,
            final org.web3moac.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<>(
                "priv_getLogs",
    ...
    @Override
    public Request<?, org.web3moac.protocol.core.methods.response.EthFilter> privNewFilter(
            String privacyGroupId, org.web3moac.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<>(
                "priv_newFilter",
                Arrays.asList(privacyGroupId, ethFilter),
                web3jService,
                org.web3moac.protocol.core.methods.response.EthFilter.class);
    }
