 ...
 */
package org.web3moac.contracts;
 ...
 * or the org.web3moac.codegen.SolidityFunctionWrapperGenerator in the <a
...
public class IMOKToken extends Contract {
    ...
    public static RemoteCall<IMOKToken> deploy(
            Web3moac web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static RemoteCall<IMOKToken> deploy(
            Web3moac web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(
