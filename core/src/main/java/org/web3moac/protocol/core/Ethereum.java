...
public interface Ethereum {
    ...
    Request<?, org.web3moac.protocol.core.methods.response.EthSendTransaction> ethSendTransaction(
            org.web3moac.protocol.core.methods.request.Transaction transaction);

    Request<?, org.web3moac.protocol.core.methods.response.EthSendTransaction>
            ethSendRawTransaction(String signedTransactionData);

    Request<?, org.web3moac.protocol.core.methods.response.EthCall> ethCall(
            org.web3moac.protocol.core.methods.request.Transaction transaction,
            DefaultBlockParameter defaultBlockParameter);
    ...
    Request<?, EthFilter> ethNewFilter(
    ...
    Request<?, EthLog> ethGetLogs(org.web3moac.protocol.core.methods.request.EthFilter ethFilter);
    ...
    Request<?, org.web3moac.protocol.core.methods.response.ShhPost> shhPost(
            org.web3moac.protocol.core.methods.request.ShhPost shhPost);
