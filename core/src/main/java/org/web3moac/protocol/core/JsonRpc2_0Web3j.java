...
import org.web3moac.protocol.core.methods.request.ShhFilter;
import org.web3moac.protocol.core.methods.request.ShhPost;
import org.web3moac.protocol.core.methods.request.Transaction;
import org.web3moac.protocol.core.methods.response.DbGetHex;
import org.web3moac.protocol.core.methods.response.DbGetString;
import org.web3moac.protocol.core.methods.response.DbPutHex;
import org.web3moac.protocol.core.methods.response.DbPutString;
import org.web3moac.protocol.core.methods.response.EthAccounts;
...
import org.web3moac.protocol.core.methods.response.EthChainId;
import org.web3moac.protocol.core.methods.response.EthCoinbase;
import org.web3moac.protocol.core.methods.response.EthCompileLLL;
import org.web3moac.protocol.core.methods.response.EthCompileSerpent;
import org.web3moac.protocol.core.methods.response.EthCompileSolidity;
import org.web3moac.protocol.core.methods.response.EthEstimateGas;
import org.web3moac.protocol.core.methods.response.EthFilter;
...
import org.web3moac.protocol.core.methods.response.EthGetBlockTransactionCountByHash;
import org.web3moac.protocol.core.methods.response.EthGetBlockTransactionCountByNumber;
import org.web3moac.protocol.core.methods.response.EthGetCode;
import org.web3moac.protocol.core.methods.response.EthGetCompilers;
import org.web3moac.protocol.core.methods.response.EthGetStorageAt;
import org.web3moac.protocol.core.methods.response.EthGetTransactionCount;
import org.web3moac.protocol.core.methods.response.EthGetTransactionReceipt;
import org.web3moac.protocol.core.methods.response.EthGetUncleCountByBlockHash;
import org.web3moac.protocol.core.methods.response.EthGetUncleCountByBlockNumber;
import org.web3moac.protocol.core.methods.response.EthGetWork;
import org.web3moac.protocol.core.methods.response.EthHashrate;
import org.web3moac.protocol.core.methods.response.EthLog;
import org.web3moac.protocol.core.methods.response.EthMining;
import org.web3moac.protocol.core.methods.response.EthProtocolVersion;
import org.web3moac.protocol.core.methods.response.EthSign;
import org.web3moac.protocol.core.methods.response.EthSubmitHashrate;
import org.web3moac.protocol.core.methods.response.EthSubmitWork;
import org.web3moac.protocol.core.methods.response.EthSubscribe;
import org.web3moac.protocol.core.methods.response.EthSyncing;
import org.web3moac.protocol.core.methods.response.EthTransaction;
import org.web3moac.protocol.core.methods.response.EthUninstallFilter;
import org.web3moac.protocol.core.methods.response.Log;
import org.web3moac.protocol.core.methods.response.NetListening;
import org.web3moac.protocol.core.methods.response.NetPeerCount;
import org.web3moac.protocol.core.methods.response.NetVersion;
import org.web3moac.protocol.core.methods.response.ShhAddToGroup;
import org.web3moac.protocol.core.methods.response.ShhHasIdentity;
import org.web3moac.protocol.core.methods.response.ShhMessages;
import org.web3moac.protocol.core.methods.response.ShhNewFilter;
import org.web3moac.protocol.core.methods.response.ShhNewGroup;
import org.web3moac.protocol.core.methods.response.ShhNewIdentity;
import org.web3moac.protocol.core.methods.response.ShhUninstallFilter;
import org.web3moac.protocol.core.methods.response.ShhVersion;
import org.web3moac.protocol.core.methods.response.Web3ClientVersion;
import org.web3moac.protocol.core.methods.response.Web3Sha3;
import org.web3moac.protocol.core.methods.response.admin.AdminNodeInfo;
import org.web3moac.protocol.core.methods.response.admin.AdminPeers;
import org.web3moac.protocol.rx.JsonRpc2_0Rx;
import org.web3moac.protocol.websocket.events.LogNotification;
import org.web3moac.protocol.websocket.events.NewHeadsNotification;
import org.web3moac.utils.Async;
import org.web3moac.utils.Numeric;

/** JSON-RPC 2.0 factory implementation. */
public class JsonRpc2_0Web3j implements Web3moac {
    ...
    public Request<?, EthChainId> ethChainId() {
        return new Request<>(
                "mc_chainId", Collections.<String>emptyList(), web3jService, EthChainId.class);
    }

    @Override
    public Request<?, EthCoinbase> ethCoinbase() {
        return new Request<>(
                "mc_coinbase", Collections.<String>emptyList(), web3jService, EthCoinbase.class);
    }

    @Override
    public Request<?, EthSyncing> ethSyncing() {
        return new Request<>(
                "mc_syncing", Collections.<String>emptyList(), web3jService, EthSyncing.class);
    }

    @Override
    public Request<?, EthMining> ethMining() {
        return new Request<>(
                "mc_mining", Collections.<String>emptyList(), web3jService, EthMining.class);
    }

    @Override
    public Request<?, EthHashrate> ethHashrate() {
        return new Request<>(
                "mc_hashrate", Collections.<String>emptyList(), web3jService, EthHashrate.class);
    }

    @Override
    public Request<?, EthGasPrice> ethGasPrice() {
        return new Request<>(
                "mc_gasPrice", Collections.<String>emptyList(), web3jService, EthGasPrice.class);
    }

    @Override
    public Request<?, EthAccounts> ethAccounts() {
        return new Request<>(
                "mc_accounts", Collections.<String>emptyList(), web3jService, EthAccounts.class);
    }
    ...
    @Override
    public Request<?, org.web3moac.protocol.core.methods.response.EthSendTransaction>
            ethSendTransaction(Transaction transaction) {
        return new Request<>(
                "mc_sendTransaction",
                Arrays.asList(transaction),
                web3jService,
                org.web3moac.protocol.core.methods.response.EthSendTransaction.class);
    }
    ...
    @Override
    public Request<?, org.web3moac.protocol.core.methods.response.EthCall> ethCall(
            Transaction transaction, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "mc_call",
                Arrays.asList(transaction, defaultBlockParameter),
                web3jService,
                org.web3moac.protocol.core.methods.response.EthCall.class);
    }

    @Override
    public Request<?, EthEstimateGas> ethEstimateGas(Transaction transaction) {
        return new Request<>(
                "mc_estimateGas", Arrays.asList(transaction), web3jService, EthEstimateGas.class);
    }
    ...
    public Request<?, EthCompileLLL> ethCompileLLL(String sourceCode) {
        return new Request<>(
                "mc_compileLLL", Arrays.asList(sourceCode), web3jService, EthCompileLLL.class);
    }
    ...
    public Request<?, EthFilter> ethNewFilter(
            org.web3moac.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<>(
                "mc_newFilter", Arrays.asList(ethFilter), web3jService, EthFilter.class);
    }
    ...
    public Request<?, EthLog> ethGetLogs(
            org.web3moac.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<>("mc_getLogs", Arrays.asList(ethFilter), web3jService, EthLog.class);
    }

    @Override
    public Request<?, EthGetWork> ethGetWork() {
        return new Request<>(
                "mc_getWork", Collections.<String>emptyList(), web3jService, EthGetWork.class);
    }
    ...
    @Override
    public Request<?, org.web3moac.protocol.core.methods.response.ShhPost> shhPost(
            ShhPost shhPost) {
        return new Request<>(
                "shh_post",
                Arrays.asList(shhPost),
                web3jService,
                org.web3moac.protocol.core.methods.response.ShhPost.class);
    }
    ...
    @Override
    public Flowable<org.web3moac.protocol.core.methods.response.Transaction> transactionFlowable() {
        return web3jRx.transactionFlowable(blockTime);
    }

    @Override
    public Flowable<org.web3moac.protocol.core.methods.response.Transaction>
