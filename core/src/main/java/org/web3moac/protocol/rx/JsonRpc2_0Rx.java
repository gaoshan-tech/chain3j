 ...
 */
package org.web3moac.protocol.rx;
...
import org.web3moac.protocol.core.DefaultBlockParameterNumber;
import org.web3moac.protocol.core.Request;
import org.web3moac.protocol.core.filters.BlockFilter;
import org.web3moac.protocol.core.filters.LogFilter;
import org.web3moac.protocol.core.filters.PendingTransactionFilter;
...
import org.web3moac.utils.Flowables;
...
public class JsonRpc2_0Rx {
    ...
    public JsonRpc2_0Rx(Web3moac web3j, ScheduledExecutorService scheduledExecutorService) {
        this.web3j = web3j;
    ...
    public Flowable<Log> ethLogFlowable(
            org.web3moac.protocol.core.methods.request.EthFilter ethFilter, long pollingInterval) {
        return Flowable.create(
                subscriber -> {
    ...
    private <T> void run(
            org.web3moac.protocol.core.filters.Filter<T> filter,
