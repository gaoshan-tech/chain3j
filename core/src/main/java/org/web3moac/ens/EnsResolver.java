 ...
 */
package org.web3moac.ens;

import org.web3moac.crypto.Keys;
import org.web3moac.crypto.WalletUtils;
import org.web3moac.ens.contracts.generated.ENS;
import org.web3moac.ens.contracts.generated.PublicResolver;
...
import org.web3moac.tx.ClientTransactionManager;
...
public class EnsResolver {
    ...
    public EnsResolver(Web3moac web3j, long syncThreshold, int addressLength) {
        this.web3j = web3j;
    ...
    public EnsResolver(Web3moac web3j, long syncThreshold) {
        this(web3j, syncThreshold, Keys.ADDRESS_LENGTH_IN_HEX);
    }

    public EnsResolver(Web3moac web3j) {
