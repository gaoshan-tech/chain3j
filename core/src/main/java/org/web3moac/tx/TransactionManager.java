...
import org.web3moac.tx.response.PollingTransactionReceiptProcessor;
import org.web3moac.tx.response.TransactionReceiptProcessor;

import static org.web3moac.protocol.core.JsonRpc2_0Web3j.DEFAULT_BLOCK_TIME;
...
public abstract class TransactionManager {
    ...
    protected TransactionManager(Web3moac web3j, String fromAddress) {
        this(
    ...
    protected TransactionManager(
            Web3moac web3j, int attempts, long sleepDuration, String fromAddress) {
    ...
    protected TransactionReceipt executeTransaction(
        ...
        return executeTransaction(
                gasPrice, gasLimit, to, data, value, false, BigInteger.ZERO, null);
    }
    ...
    protected TransactionReceipt executeTransaction(
        ...
        EthSendTransaction ethSendTransaction =
                sendTransaction(
                        gasPrice, gasLimit, to, data, value, constructor, shardingflag, via);
    ...
    protected TransactionReceipt executeTransactionEIP1559(
        ...
        return executeTransactionEIP1559(
                gasPremium, feeCap, gasLimit, to, data, value, false, BigInteger.ZERO, null);
    }
    ...
    protected TransactionReceipt executeTransactionEIP1559(
        ...
        return executeTransactionEIP1559(
                gasPremium, feeCap, gasLimit, to, data, value, false, shardingflag, via);
    }
