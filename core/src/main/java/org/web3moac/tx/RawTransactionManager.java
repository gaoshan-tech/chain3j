...
import org.web3moac.tx.exceptions.TxHashMismatchException;
import org.web3moac.tx.response.TransactionReceiptProcessor;
import org.web3moac.utils.Numeric;
import org.web3moac.utils.TxHashVerifier;
...
public class RawTransactionManager extends TransactionManager {
    ...
    public RawTransactionManager(Web3moac web3j, Credentials credentials, long chainId) {
    ...
    public RawTransactionManager(Web3moac web3j, Credentials credentials) {
        this(web3j, credentials, ChainId.MC_MAINNET);
    }

    public RawTransactionManager(
            Web3moac web3j, Credentials credentials, int attempts, int sleepDuration) {
