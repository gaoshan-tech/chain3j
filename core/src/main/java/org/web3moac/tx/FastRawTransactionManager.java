...
public class FastRawTransactionManager extends RawTransactionManager {
    ...
    public FastRawTransactionManager(Web3moac web3j, Credentials credentials, byte chainId) {
        super(web3j, credentials, chainId);
    }

    public FastRawTransactionManager(Web3moac web3j, Credentials credentials) {
    ...
    public FastRawTransactionManager(
        ...
        super(web3j, credentials, ChainId.MC_MAINNET, transactionReceiptProcessor);
    }
