...
public abstract class ManagedTransaction {
    ...
    protected Web3moac web3j;

    protected TransactionManager transactionManager;

    protected EnsResolver ensResolver;

    protected ManagedTransaction(Web3moac web3j, TransactionManager transactionManager) {
        this(new EnsResolver(web3j), web3j, transactionManager);
    }

    protected ManagedTransaction(
            EnsResolver ensResolver, Web3moac web3j, TransactionManager transactionManager) {
