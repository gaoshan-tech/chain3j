...
import org.web3moac.tx.RawTransactionManager;
...
public class LucyInfoClient {
    ...
    public Web3moac getWeb3j() {
        return web3j;
    }

    public void setWeb3j(Web3moac web3j) {
        this.web3j = web3j;
    }
    ...
    public void deployAssetAndRecordAddr() {
        ...
        try {
            IMOKToken imokToken =
                    IMOKToken.deploy(web3j, credentials, new StaticGasProvider(gasPrice, gasLimit))
                            .send();
            System.out.println(
