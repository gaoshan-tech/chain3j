 ...
 * Typed {@link org.web3moac.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.web3moac.abi.datatypes.Type>
    ...
    public static <T extends org.web3moac.abi.datatypes.Type> TypeReference<T> create(
            Class<T> cls) {
     ...
     */
    protected static Class<? extends org.web3moac.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends org.web3moac.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends org.web3moac.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends org.web3moac.abi.datatypes.Type> baseClass =
        ...
        while (lastReadStringPosition < len) {
            ...
            if (arraySize == null || arraySize.equals("")) {
                ...
                if (arraySizeInt <= StaticArray.MAX_SIZE_OF_STATIC_ARRAY) {
                    arrayclass =
                            Class.forName(
                                    "org.web3moac.abi.datatypes.generated.StaticArray" + arraySize);
                } else {
